...
class HeatBlueColorSpacer extends AbstractStyler {

    private flavor :string;

    constructor(){
        super("HeatBlueColorSpacer");
    }
    ...
    private setBasedOnGeneration(parentBox: IBox, childBox: IBox) {
        ...
        if(count){
            childBox.setColor(ColorManager.lighten(ColorManager.OPGblue(), 16 * count));
            return;
        }
        childBox.setColor(ColorManager.OPGblue());
    }
