 ...
 */
class SmallPictureDetailBox2 extends IBoxData {
    render(box:IBox, rootElement): any {
        ...
        rect.setAttribute('stroke', 'black');rect.setAttribute('stroke', 'black');
