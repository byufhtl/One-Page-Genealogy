...
class JSXLSpRotBox extends IBoxData {
    render(box:IBox, rootElement): any {
        ...
        rect.setAttribute('width', String(this.getWidth() - 94));
        rect.setAttribute('height', String(box.getHeight() - 136 - box.getSpace()));
        ...
        rect2.setAttribute('width', String(this.getWidth() - 127));
        rect2.setAttribute('height', String(box.getHeight() - 168 - box.getSpace()));
        ...
        //text3.setAttribute("x", "280");
        text3.setAttribute("y", "60");
        text3.setAttribute("font-size", "36px");
        ...
        //text4.setAttribute("x", "280");
        text4.setAttribute("y", "110");
        text4.setAttribute("font-size", "36px");
        ...
        if (spousenode != null) {
            ...
            //text6.setAttribute("x", "180");
            text6.setAttribute("y", "0");
            text6.setAttribute("font-size", "60px");
            ...
            //text7.setAttribute("x", "180");
            text7.setAttribute("y", "60");//"45");
            text7.setAttribute("font-size", "36px");
            ...
            //text8.setAttribute("x", "180");
            text8.setAttribute("y", "110");
            text8.setAttribute("font-size", "36px");
        ...
        //text10.setAttribute("x", "560");
        text10.setAttribute("y", "290");
        text10.setAttribute("font-size", "36px");
