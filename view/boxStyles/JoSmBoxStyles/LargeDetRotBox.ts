...
class JSLargeDetRotBox implements IBoxRender {
    render(box:IBox, rootElement): any {
        ...
        StringUtils.fitDatePlace(text3,node.getAttr('birthdate'),node.getAttr('birthplace'),45);
        ...
        StringUtils.fitDatePlace(text4,node.getAttr('deathdate'),node.getAttr('deathplace'),45);
