...
class JSMassiveSpRotBox extends IBoxData {
    render(box:IBox, rootElement): any {
        ...
        if (spousenode != null) {
            ...
            StringUtils.fitDatePlace(text7, spousenode.getAttr('birthdate'), spousenode.getAttr('birthplace'), 24);
            ...
            StringUtils.fitDatePlace(text8, spousenode.getAttr('deathdate'), spousenode.getAttr('deathplace'), 24);
